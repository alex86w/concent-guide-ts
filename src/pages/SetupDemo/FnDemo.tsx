...
export type CtxPre = CtxMS<IDemoProps, "SetupDemo", ReturnType<typeof iState>>;
...
export const setup = (ctx: CtxPre) => {
  ...
  const getBooks = () => {
    ctx.mr.getBooks(ctx.state.startTime);
  };
...
export type Ctx = CtxMS<
  IDemoProps,
  "SetupDemo",
  ReturnType<typeof iState>,
  Settings
>;
// export type Ctx = CtxMSConn<IDemoProps, SetupDemoM, ReturnType<typeof iState>, FooM, Settings>;

export default React.memo(function (props) {
  const ctx = useConcent<{}, Ctx>({
    module: SetupDemo,
    state: iState,
    setup,
    props
